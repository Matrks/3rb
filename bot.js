...
client.on('message', message => {
    if(message.content.startsWith(prefix + "toggleAntihack")) {
        ...
        if(!antihack[message.guild.id]) antihack[message.guild.id] = {
          ...
          if(antihack[message.guild.id].onoff === 'Off') return [message.channel.send(`**AntiHack On**`), antihack[message.guild.id].onoff = 'On']
          if(antihack[message.guild.id].onoff === 'On') return [message.channel.send(`**AntiHack Off**`), antihack[message.guild.id].onoff = 'Off']
...
message.channel.send(`**AntiBots On**`)
